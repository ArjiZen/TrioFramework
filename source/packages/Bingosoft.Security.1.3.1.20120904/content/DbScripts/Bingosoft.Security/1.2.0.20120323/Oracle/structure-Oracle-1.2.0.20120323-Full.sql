CREATE TABLE SEC_LOG  (
   ...
   LOG_TYPE             VARCHAR2(10)                   DEFAULT 'login' NOT NULL
      CONSTRAINT CKC_LOG_TYPE_SEC_LOG CHECK (LOG_TYPE IN ('login','operation','auth')),
...
CREATE TABLE SEC_ORG_ROLE  (
   ...
   CONSTRAINT PK_SEC_ORG_ROLE PRIMARY KEY (ORG_ID, ROLE_ID)
);
...
CREATE TABLE SEC_PERMISSION_RESOURCE  (
   ...
   LAST_UPDATED_BY      VARCHAR2(38)                    NOT NULL,
   LAST_UPDATED_DATE    DATE                            NOT NULL,
   CONSTRAINT PK_SEC_PERMISSION_RESOURCE PRIMARY KEY (ID)
);
...
CREATE TABLE SEC_PERMISSION  (
   ...
   ELEMENT_BEHAVIOUR    VARCHAR2(30)                   
      CONSTRAINT CKC_ELEMENT_BEHAVIOUR_SEC_PERM CHECK (ELEMENT_BEHAVIOUR IS NULL OR (ELEMENT_BEHAVIOUR IN ('invisible','disabled'))),
...
CREATE TABLE SEC_PERMISSION_RULE  (
   ...
   IS_DEFAULT           INTEGER                        DEFAULT 0 NOT NULL
      CONSTRAINT CKC_IS_DEFAULT_SEC_PERM CHECK (IS_DEFAULT IN (0,1)),
   CREATED_BY           VARCHAR2(38)                    NOT NULL,
   CREATED_DATE         DATE                            NOT NULL,
   LAST_UPDATED_BY      VARCHAR2(38)                    NOT NULL,
   LAST_UPDATED_DATE    DATE                            NOT NULL,
   CONSTRAINT PK_SEC_PERMISSION_RULE PRIMARY KEY (ID)
);
...
CREATE TABLE SEC_ROLE  (
   ...
   PARTICIPANT_TYPE     SMALLINT                       DEFAULT NULL
      CONSTRAINT CKC_PARTICIPANT_TYPE_SEC_ROLE CHECK (PARTICIPANT_TYPE IS NULL OR (PARTICIPANT_TYPE IN (0,1))),
   CREATED_BY           VARCHAR2(38)                    NOT NULL,
   CREATED_DATE         DATE                            NOT NULL,
   LAST_UPDATED_BY      VARCHAR2(38)                    NOT NULL,
   LAST_UPDATED_DATE    DATE                            NOT NULL,
...
CREATE TABLE SEC_ROLE_INHERITANCE  (
   ...
   LAST_UPDATED_BY      VARCHAR2(38)                    NOT NULL,
   LAST_UPDATED_DATE    DATE                            NOT NULL,
   CONSTRAINT PK_SEC_ROLE_INHERITANCE PRIMARY KEY (PARENT_ROLE_ID, CHILD_ROLE_ID)
);
...
CREATE TABLE SEC_ROLE_PERMISSION  (
   ...
   LAST_UPDATED_BY      VARCHAR2(38)                    NOT NULL,
   LAST_UPDATED_DATE    DATE                            NOT NULL,
   CONSTRAINT PK_SEC_ROLE_PERMISSION PRIMARY KEY (ROLE_ID, OPERATION_ID)
);
...
CREATE TABLE SEC_USER  (
   ...
   CONSTRAINT AK_AK_USERLOGINID_SEC_USER UNIQUE (LOGIN_ID, TYPE)
);
...
CREATE TABLE SEC_WORKDAY  (
   DAY                  DATE                            NOT NULL,
   ORG_ID               VARCHAR2(38)                    NOT NULL,
   IS_WORK              SMALLINT                       DEFAULT 0
      CONSTRAINT CKC_IS_WORK_SEC_WORK CHECK (IS_WORK IS NULL OR (IS_WORK IN (0,1))),
   DESCRIPTION          VARCHAR2(300),
   CONSTRAINT PK_SEC_WORKDAY PRIMARY KEY (DAY, ORG_ID)
);

COMMENT ON TABLE SEC_WORKDAY IS
'工作日表，定义特定组织机构的工作日情况';

COMMENT ON COLUMN SEC_WORKDAY.DAY IS
'工作日标识';

COMMENT ON COLUMN SEC_WORKDAY.ORG_ID IS
'组织标识';

COMMENT ON COLUMN SEC_WORKDAY.IS_WORK IS
'是否是工作日(0 非工作日 1 工作日)';

COMMENT ON COLUMN SEC_WORKDAY.DESCRIPTION IS
'备注';
...
CREATE TABLE SEC_WF_ORG_ROLE  (
   ORG_ID               VARCHAR2(38)                    NOT NULL,
   WF_ROLE_ID           VARCHAR2(38)                    NOT NULL,
   ID                   VARCHAR2(38),
   CREATED_BY           VARCHAR2(38)                    NOT NULL,
   CREATED_DATE         DATE                            NOT NULL,
   LAST_UPDATED_BY      VARCHAR2(38)                    NOT NULL,
   LAST_UPDATED_DATE    DATE                            NOT NULL,
   CONSTRAINT PK_SEC_WF_ORG_ROLE PRIMARY KEY (ORG_ID, WF_ROLE_ID)
);

COMMENT ON TABLE SEC_WF_ORG_ROLE IS
'部门参与者角色里对应的会签部门';

COMMENT ON COLUMN SEC_WF_ORG_ROLE.ORG_ID IS
'组织标识';

COMMENT ON COLUMN SEC_WF_ORG_ROLE.WF_ROLE_ID IS
'流程角色标识';

COMMENT ON COLUMN SEC_WF_ORG_ROLE.ID IS
'组织标识';

COMMENT ON COLUMN SEC_WF_ORG_ROLE.CREATED_BY IS
'创建人';

COMMENT ON COLUMN SEC_WF_ORG_ROLE.CREATED_DATE IS
'创建时间';

COMMENT ON COLUMN SEC_WF_ORG_ROLE.LAST_UPDATED_BY IS
'最后修改人';

COMMENT ON COLUMN SEC_WF_ORG_ROLE.LAST_UPDATED_DATE IS
'最后修改时间';
...
CREATE TABLE SEC_WF_USER_ROLE  (
   ...
   LAST_UPDATED_BY      VARCHAR2(38)                    NOT NULL,
   LAST_UPDATED_DATE    DATE                            NOT NULL,
   CONSTRAINT PK_SEC_WF_USER_ROLE PRIMARY KEY (WF_ROLE_ID, USER_ID)
);

COMMENT ON TABLE SEC_WF_USER_ROLE IS
'用户流程角色';

COMMENT ON COLUMN SEC_WF_USER_ROLE.USER_ID IS
'用户标识';

COMMENT ON COLUMN SEC_WF_USER_ROLE.WF_ROLE_ID IS
'流程角色标识';

COMMENT ON COLUMN SEC_WF_USER_ROLE.CREATED_BY IS
'创建人';

COMMENT ON COLUMN SEC_WF_USER_ROLE.CREATED_DATE IS
'创建时间';

COMMENT ON COLUMN SEC_WF_USER_ROLE.LAST_UPDATED_BY IS
'最后修改人';

COMMENT ON COLUMN SEC_WF_USER_ROLE.LAST_UPDATED_DATE IS
'最后修改时间';
...
CREATE TABLE SEC_WF_ROLE  (
   ...
   CONSTRAINT AK_KEY_2_SEC_WF_R UNIQUE (ROLE_ID, ORG_ID)
);

COMMENT ON COLUMN SEC_WF_ROLE.ID IS
'流程角色标识';

COMMENT ON COLUMN SEC_WF_ROLE.ROLE_ID IS
'角色标识（只能是流转类角色和混合类角色）';

COMMENT ON COLUMN SEC_WF_ROLE.ORG_ID IS
'组织标识';

COMMENT ON COLUMN SEC_WF_ROLE.CREATED_BY IS
'创建人';

COMMENT ON COLUMN SEC_WF_ROLE.CREATED_DATE IS
'创建时间';

COMMENT ON COLUMN SEC_WF_ROLE.LAST_UPDATED_BY IS
'最后修改人';

COMMENT ON COLUMN SEC_WF_ROLE.LAST_UPDATED_DATE IS
'最后修改时间';
...
ALTER TABLE SEC_WORKDAY
   ADD CONSTRAINT FK_SEC_WORK_REFERENCE_SEC_ORGA FOREIGN KEY (ORG_ID)
      REFERENCES SEC_ORGANIZATION (ID);

ALTER TABLE SEC_WF_ORG_ROLE
   ADD CONSTRAINT FK_SEC_WF_O_REFERENCE_SEC_ORGA FOREIGN KEY (ID)
      REFERENCES SEC_ORGANIZATION (ID);

ALTER TABLE SEC_WF_ORG_ROLE
   ADD CONSTRAINT FK_SEC_WF_O_REFERENCE_SEC_WF_R FOREIGN KEY (WF_ROLE_ID)
      REFERENCES SEC_WF_ROLE (ID)
      ON DELETE CASCADE;

ALTER TABLE SEC_WF_USER_ROLE
   ADD CONSTRAINT FK_SEC_WF_U_REFERENCE_SEC_WF_R FOREIGN KEY (WF_ROLE_ID)
      REFERENCES SEC_WF_ROLE (ID)
      ON DELETE CASCADE;

ALTER TABLE SEC_WF_ROLE
   ADD CONSTRAINT FK_SEC_WF_R_REFERENCE_SEC_ORGA FOREIGN KEY (ORG_ID)
      REFERENCES SEC_ORGANIZATION (ID);

ALTER TABLE SEC_WF_ROLE
   ADD CONSTRAINT FK_SEC_WF_R_REFERENCE_SEC_ROLE FOREIGN KEY (ROLE_ID)
      REFERENCES SEC_ROLE (ID);
